...
import HexTierBoard from '~/component/editor/HexSelection/HexTierBoard'
import SearchBar from '~/component/editor/HexSelection/SearchBar'
...
import { DraggableHex } from '../HexSelection/DraggableHex'
...
const HexSelection = () => {
  const [dispatch, tier1, tier2, tier3] = useModifyStore(
    (state) => [
  ...
  return (
    <div className="grid grid-cols-7 gap-3 pt-4 pb-36">
      <div className="col-span-5 ">
        <MutedCardWithHeader
          header={Tab(tabs, handleClickTabs)}
