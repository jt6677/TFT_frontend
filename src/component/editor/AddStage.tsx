...
function AddTutorial() {
  const [stageTutorialDispatch] = useEditorStore((state) => [state.stageTutorialDispatch], shallow)
  return (
    <motion.div
...
function AddStage() {
  const [stageTutorial] = useEditorStore((state) => [state.stageTutorial], shallow)
  return (
    <>
